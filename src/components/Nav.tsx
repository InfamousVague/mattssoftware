...
/// Inline Discord mark — same rationale as the GitHub mark above.
/// The path is the canonical wordmark-less "Clyde" silhouette.
...
/// Public Discord invite — kept top-level so the libre.academy nav can
/// import it too once the two repos start sharing a small "social
/// links" data file (not done yet; this constant is the seed).
